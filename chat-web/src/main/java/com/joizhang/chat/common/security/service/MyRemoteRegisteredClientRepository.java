...
import com.joizhang.chat.admin.controller.SysOauthClientDetailsController;
...
public class MyRemoteRegisteredClientRepository implements RegisteredClientRepository {
     ...
     */
    private final SysOauthClientDetailsController clientDetailsService;
    ...
    public RegisteredClient findByClientId(String clientId) {
        ...
        Integer accessTokenTTL = Optional.ofNullable(clientDetails.getAccessTokenValidity())
                .orElse(accessTokenValiditySeconds);
        Integer refreshTokenTTL = Optional.ofNullable(clientDetails.getRefreshTokenValidity())
